...
public class ChooseYourFood extends HttpServlet {
    ...
    private void ucitajLozinku(){
        String path = "C:\\Users\\Korisnik\\OneDrive\\Desktop\\chooseYourFood\\src\\main\\java\\com\\example\\chooseyourfood\\password.txt";
    ...
    private void ucitajJela(List<Map<String, Integer>> dan, String d){
        ...
        String path = "C:\\Users\\Korisnik\\OneDrive\\Desktop\\chooseYourFood\\src\\main\\java\\com\\example\\chooseyourfood\\jela\\" + d;
        try {
            BufferedReader reader = new BufferedReader(new FileReader(path));
            String line;
